...
const CARD_POSITIONS = {
    ...
    // 13吋螢幕（≤ 1440px）
    small: {
        'us':                { left: '17.41%', top: '25.1%' },
        'gb':                { left: '33.7%', top: '27.6%' },
        'de':                { left: '48.6%', top: '21.2%' },
        'fr':                { left: '34.2%', top: '48.9%' },
        'kr':                { left: '63.2%', top: '39.7%' },
        'jp':                { left: '81.9%', top: '31%' },
        'hk':                { left: '59%', top: '60%' },
        'tw':                { left: '79%', top: '60%' },
        'etf-world':         { left: '88.7%', top: '1.2%'  },
        'etf-northamerica':  { left: '3.4%', top: '24.3%' },
        'etf-southamerica':  { left: '12.3%', top: '67%' },
        'etf-westeurope':    { left: '29.2%', top: '12.1%' },
        'etf-southeurope':   { left: '38.7%', top: '62.4%' },
        'etf-northeurope':   { left: '48%', top: '12.1%' },
        'etf-eastasia':      { left: '81.2%', top: '30.3%' },
        'etf-asiatigers':    { left: '81.2%', top: '51.3%' },
        'etf-southeastasia': { left: '56.9%', top: '70.6%' },
        'etf-australia':     { left: '81.2%', top: '83.5%' },
        'etf-middleeast':    { left: '58.5%', top: '33.6%' },
        'etf-africa':        { left: '37.5%', top: '86.3%'   },
    }
};
